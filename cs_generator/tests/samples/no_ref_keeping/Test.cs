...
namespace TestNamespace
{
    public partial class Test    
    {
        ...
        public readonly IReadOnlyList<float> lst_var; 
        public readonly IReadOnlyList<Dog> lst_nullable_dog; 
        public readonly IReadOnlyList<dynamic> lst_dynamic; 
        public readonly IReadOnlyList<int> tup_var; 
        public readonly IReadOnlyList<dynamic> tup_dynamic; 
        public readonly IReadOnlyDictionary<int, string> dct_int_str; 
        public readonly IReadOnlyDictionary<string, dynamic> dct_str_dynamic; 
        public readonly IReadOnlyDictionary<Job, float> dct_enum_float; 
        public readonly IReadOnlyList<IReadOnlyDictionary<string, Job?>> nested; 
